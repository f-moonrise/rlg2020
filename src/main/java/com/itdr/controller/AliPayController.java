...
public class AliPayController {
    ...
    public String payCallback(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            if (!result) {
                //验签失败，返回错误信息
                sr = ServerResponse.defeatedRS(ConstCode.OrderEnum.FAIL_Check.getCode(),ConstCode.OrderEnum.FAIL_Check.getDesc());
                //数据转换成json数据格式
                //数据返回给浏览器
